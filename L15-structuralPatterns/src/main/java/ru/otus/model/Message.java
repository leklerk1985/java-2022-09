...
public class Message {
    ...
    public static Message createCopy(Message msg) {
        return new Message.Builder(msg.getId())
                ...
                .field13(ObjectForMessage.createCopy(msg.getField13()))
                .build();
    }
    ...
    public static class Builder {
        ...
        public Builder setUniqueId(HistoryListener historyListener) {
            this.id = historyListener.calculateUniqueId();
            return this;
        }
