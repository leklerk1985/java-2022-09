...
public class DirectionsManager {
    ...
    public MovingDirection chooseFirstDirection(Coordinates hCoordinates, Coordinates vCoordinates, Coordinates vcCoordinates, Coordinates hcCoordinates,
        ...
        if (!horizontalDirectionIsDefault && coordinatesAreValid(hCoordinates) && playField.getCharacter(hCoordinates.get(1), hCoordinates.get(2)).isEmptyOrPlayer()) {
            aCoordinates.copyCoordinates(hCoordinates);
            return horizontalDir;
        } else if (coordinatesAreValid(vCoordinates) && playField.getCharacter(vCoordinates.get(1), vCoordinates.get(2)).isEmptyOrPlayer()) {
