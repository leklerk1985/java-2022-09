...
import ru.otus.webserver.servlet.AllClientsServlet;
import ru.otus.webserver.servlet.ClientsServlet;
import ru.otus.webserver.servlet.NewClientServlet;
...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private Server initContext() {
        ...
        handlers.addHandler(applySecurity(servletContextHandler, "/clients", "/allclients", "/newclient"));
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new AllClientsServlet(templateProcessor, gson)), "/allclients");
        servletContextHandler.addServlet(new ServletHolder(new NewClientServlet(templateProcessor, gson)), "/newclient");
        return servletContextHandler;
    }
}